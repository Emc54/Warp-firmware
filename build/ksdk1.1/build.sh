#!/bin/sh
    ...
    cp ../../src/boot/ksdk1.1.0/arithmetic_propagation.*    work/demos/Warp/src/
    cp ../../src/boot/ksdk1.1.0/statistics.*			work/demos/Warp/src/
    cp ../../src/boot/ksdk1.1.0/FFT.*                   work/demos/Warp/src/
	...
	echo "\n\nNow, run\n\n\tJLinkExe -device MKL03Z32XXX4 -if SWD -speed 100000 -CommanderScript ~/Warp-firmware/tools/scripts/jlink.commands\n\n"
