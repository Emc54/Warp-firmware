...
typedef enum
{
	...
	kWarpTypeMaskShuntVoltage	= (1 << 12),
	/*
...
typedef enum
{
	...
	kWarpSensorOutputRegisterINA219_SV					= 0x01,
	kWarpSensorOutputRegisterINA219_BV					= 0x02,
	kWarpSensorOutputRegisterINA219_C					= 0x03,
	kWarpSensorOutputRegisterINA219_P					= 0x04,
